...
Most other papers that look at declines in industrialization or manufacturing that use exposure shocks use exposure as a continuous variable. \cite{howard2024universities} and \cite{glaeser2003rise} both use baseline manufacturing employment shares as a measure for manufacturing exposure in different years. For robustness checks, \cite{howard2024universities} define high exposure shock as above-median manufacturing employment share among specific counties in 1978 (the peak of U.S manufacturing employment). Similarly \cite{gagliardi2023rust} looks at the effect of de-industrialization on cities in six countries and defines the de-industrialization exposure shock 
as a city's share of manufacturing employment in the year of its country's manufacturing peak. Low and high exposure cities are defined by using terciles of the distribution. Former manufacturing hubs are defined as cities with an initial manufacturing employment share in the top tercile of their country's distribution while middle and bottom terciles are used for comparison. \cite{autor2013china} analyze the effects of rising Chinese import competition between 1990 and 2007 on US local labor markets, exploiting cross-market variation in import exposure stemming from initial differences in industry specialization. They define exposure as local industry employment shares in time t and compare percentiles (25th and 75th percentiles) as well as the median to contextualize magnitudes of exposure. 
