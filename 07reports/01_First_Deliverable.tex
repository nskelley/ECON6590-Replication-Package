...
\begin{enumerate}
    ...
    \item \textbf{Monotonicity:} Higher $\text{coal\_growth}_t$ weakly increases $D_{kt}$ for all $k$. When national coal jobs rise, every coal-dependent county moves in the same direction (no “defiers”). \nb{This may not hold, but I wonder if the Dechaisemartin (2017) (more compliers than defiers at all times) assumption can help bail us out!}
\end{enumerate}
...
\begin{sidewaystable}[!htp]
    \centering
    \caption{Na\"ive regression of felony rates}
    \include{04work/felony_naive_table}
...
\begin{sidewaystable}[!htp]
    \centering
    \caption{Na\"ive regression of misdemeanor rates}
    \include{04work/misdemeanor_naive_table}
    \begin{minipage}{0.96\textwidth}
        \small\vspace{-1.5em}
