...
\tk{Push zotero to git and overleaf when you get a chance @Nick!}
...
\begin{figure}[!htp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{06figures/graphs/n_obs_by_window.pdf}
...
\begin{table}[!htp]
    ...
    \include{06figures/tables/state_frequency}
    \begin{minipage}{0.8\linewidth}
        \footnotesize\textit{Notes}: \tk{Omg this table is so sad}
    \end{minipage}
